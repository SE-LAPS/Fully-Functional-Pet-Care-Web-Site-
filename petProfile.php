...
if (isset($_POST["submit"])) {
    ...
    if ($_FILES["photo"]["error"] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($file_tmp, $target_file)) {
            ...
            $conn = new mysqli("localhost", "root", "", "pet_finder_db");
        ...
        <div class="container-fluid justify-content-center">
                <div class="footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                                <a class="custom-button" href="#">Gallery</a>
                            </div>
                            <div class="col-md-4">
                                <a class="custom-button" href="#">Vaccination</a>
                            </div>
                            <div class="col-md-4">
                                <a class="custom-button" href="#">Appointments</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<section>
                <div class="col-md-10 offset-md-1 page-wrap">
                    <div class="row no-gutters portfolio-topic">
                        <h1 class="sub-topic">Puppy Vaccination</h1>
                    </div>
...
<section>
                <div class="col-md-10 offset-md-1 page-wrap">
                    <div class="row no-gutters portfolio-topic">
                        <h1 class="sub-topic">Appointments</h1>
                    </div>
